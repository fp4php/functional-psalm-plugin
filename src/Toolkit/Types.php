...
final class Types
{
    ...
    public function getType(
        StatementsSource|NodeTypeProvider|AfterMethodCallAnalysisEvent|AfterFunctionCallAnalysisEvent|MethodReturnTypeProviderEvent|AfterStatementAnalysisEvent|FunctionReturnTypeProviderEvent|AfterExpressionAnalysisEvent $from,
    ...
    public function setType(
        StatementsSource|NodeTypeProvider|AfterMethodCallAnalysisEvent|AfterFunctionCallAnalysisEvent|MethodReturnTypeProviderEvent|AfterStatementAnalysisEvent|FunctionReturnTypeProviderEvent|AfterExpressionAnalysisEvent $to,
        Node\Expr|Node\Name|Node\Stmt\Return_                                                                                                                                                                                $for,
        Union                                                                                                                                                                                                                $type,
    ): void
    {
        ...
        return new Union(
            map(asList($type->getAtomicTypes()), fn($a) => match (true) {
                ...
                $a instanceof TLiteralInt,
                    $a instanceof TIntRange => new TInt(),
